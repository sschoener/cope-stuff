...
namespace cope.Graphs
{
    ...
    public class DepthFirstWalker<TNode, TEdge> : IEnumerable<TNode>
    {
        /// <summary>
        ...
        public DepthFirstWalker(IGraph<TNode, TEdge> graph, TNode start, bool includeStartNode = true)
        {
            Graph = graph;
            StartNode = start;
        ...
        {
            return new DepthFirstEnumerator<TNode, TEdge>(Graph, StartNode, IncludeStartNode);
        }
