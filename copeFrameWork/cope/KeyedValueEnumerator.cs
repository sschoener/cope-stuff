...
namespace cope
{
    ...
    /// </summary>
    internal class KeyedValueEnumerator : IEnumerator<KeyedValue>
    {
        private readonly Stack<IEnumerator<KeyedValue>> m_parentStack;
        private readonly KeyedValue m_startValue;

        public KeyedValueEnumerator(KeyedValue value)
        {
            m_startValue = value;
            m_parentStack = new Stack<IEnumerator<KeyedValue>>();
        }
        ...
        public bool MoveNext()
        {
            ...
            var table = Current.Value as KeyValueTable;
        ...
        /// </returns>
        public KeyedValue Current { get; private set; }
        ...
        {
            if (Current.Type != KeyValueType.Table)
                return true;
            var table = Current.Value as KeyValueTable;
