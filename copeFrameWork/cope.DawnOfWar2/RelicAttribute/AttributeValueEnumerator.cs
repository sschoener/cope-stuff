...
namespace cope.DawnOfWar2.RelicAttribute
{
    ...
    internal class AttributeValueEnumerator : IEnumerator<AttributeValue>
    {
        ...
        /// <exception cref="CopeDoW2Exception">The AttributeTree has been changed during the iteration!Don't change the parents of AttributeValues during the iteration.</exception>
